...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Solidigm P41 Plus NVMe SSD (DRAM-less) [Echo Harbor] (rev 03) (prog-if 02 [NVM Express])
...
Full benchmark: https://pibenchmarks.com/benchmark/134319/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 205 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 356.88 MB/s |
| FIO | 4k Random Read | 76417 IOPS IOPS |
| FIO | 4k Random Write | 36312 IOPS IOPS |
| FIO | 4k Random Read | 305671 KB/s KB/s |
| FIO | 4k Random Write | 145248 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 47.17 MB/s |
| iozone 4K random write     | 89.78 MB/s |
| iozone 1M random read      | 344.75 MB/s |
| iozone 1M random write     | 327.60 MB/s |
| iozone 1M sequential read  | 350.45 MB/s |
| iozone 1M sequential write | 334.27 MB/s |
