...
Full benchmark: https://pibenchmarks.com/benchmark/134316/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 211 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 344.52 MB/s |
| FIO | 4k Random Read | 51200 IOPS IOPS |
| FIO | 4k Random Write | 39766 IOPS IOPS |
| FIO | 4k Random Read | 204800 KB/s KB/s |
| FIO | 4k Random Write | 159067 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 39.27 MB/s |
| iozone 4K random write     | 111.94 MB/s |
| iozone 1M random read      | 321.65 MB/s |
| iozone 1M random write     | 352.59 MB/s |
| iozone 1M sequential read  | 322.13 MB/s |
| iozone 1M sequential write | 352.85 MB/s |
