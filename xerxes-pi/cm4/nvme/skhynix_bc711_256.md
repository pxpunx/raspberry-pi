...
01:00.0 Non-Volatile memory controller: SK hynix Gold P31/BC711/PC711 NVMe Solid State Drive (prog-if 02 [NVM Express])
  ...
  Capabilities: [900 v1] L1 PM Substates
    ...
    L1SubCtl1: PCI-PM_L1.2- PCI-PM_L1.1- ASPM_L1.2- ASPM_L1.1-
          T_CommonMode=0us LTR1.2_Threshold=74752ns
...
Full benchmark: https://pibenchmarks.com/benchmark/134315/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 207 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 356.09 MB/s |
| FIO | 4k Random Read | 74472 IOPS IOPS |
| FIO | 4k Random Write | 39384 IOPS IOPS |
| FIO | 4k Random Read | 297890 KB/s KB/s |
| FIO | 4k Random Write | 157538 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 45.23 MB/s |
| iozone 4K random write     | 102.83 MB/s |
| iozone 1M random read      | 346.48 MB/s |
| iozone 1M random write     | 348.81 MB/s |
| iozone 1M sequential read  | 355.80 MB/s |
| iozone 1M sequential write | 349.35 MB/s |
