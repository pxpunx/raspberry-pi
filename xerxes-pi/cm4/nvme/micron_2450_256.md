...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Micron Technology Inc 2450 NVMe SSD [HendrixV] (DRAM-less) (rev 01) (prog-if 02 [NVM Express])
...
Full benchmark: https://pibenchmarks.com/benchmark/134313/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 208 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 214.53 MB/s |
| FIO | 4k Random Read | 76133 IOPS IOPS |
| FIO | 4k Random Write | 39844 IOPS IOPS |
| FIO | 4k Random Read | 304535 KB/s KB/s |
| FIO | 4k Random Write | 159377 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 38.59 MB/s |
| iozone 4K random write     | 106.62 MB/s |
| iozone 1M random read      | 268.52 MB/s |
| iozone 1M random write     | 345.15 MB/s |
| iozone 1M sequential read  | 335.14 MB/s |
| iozone 1M sequential write | 342.80 MB/s |
