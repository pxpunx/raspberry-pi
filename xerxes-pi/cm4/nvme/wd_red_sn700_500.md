...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Sandisk Corp SanDisk Extreme Pro / WD Black SN750 / PC SN730 / Red SN700 NVMe SSD (prog-if 02 [NVM Express])
...
Full benchmark: https://pibenchmarks.com/benchmark/134322/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 204 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 353.21 MB/s |
| FIO | 4k Random Read | 79379 IOPS IOPS |
| FIO | 4k Random Write | 40314 IOPS IOPS |
| FIO | 4k Random Read | 317519 KB/s KB/s |
| FIO | 4k Random Write | 161259 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 38.14 MB/s |
| iozone 4K random write     | 107.87 MB/s |
| iozone 1M random read      | 346.06 MB/s |
| iozone 1M random write     | 332.79 MB/s |
| iozone 1M sequential read  | 347.35 MB/s |
| iozone 1M sequential write | 336.26 MB/s |
