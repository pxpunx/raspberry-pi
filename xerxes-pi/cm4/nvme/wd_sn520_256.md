...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Sandisk Corp WD Blue SN500 / PC SN520 x2 M.2 2280 NVMe SSD (rev 01) (prog-if 02 [NVM Express])
...
Full benchmark: https://pibenchmarks.com/benchmark/134330/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 209 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 353.23 MB/s |
| FIO | 4k Random Read | 69423 IOPS IOPS |
| FIO | 4k Random Write | 40000 IOPS IOPS |
| FIO | 4k Random Read | 277694 KB/s KB/s |
| FIO | 4k Random Write | 160000 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 37.65 MB/s |
| iozone 4K random write     | 108.13 MB/s |
| iozone 1M random read      | 344.85 MB/s |
| iozone 1M random write     | 355.03 MB/s |
| iozone 1M sequential read  | 337.10 MB/s |
| iozone 1M sequential write | 355.31 MB/s |
