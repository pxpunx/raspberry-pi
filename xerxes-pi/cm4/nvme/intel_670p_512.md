...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Intel Corporation SSD 670p Series [Keystone Harbor] (rev 03) (prog-if 02 [NVM Express])
...
Full benchmark: https://pibenchmarks.com/benchmark/134321/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 207 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 350.12 MB/s |
| FIO | 4k Random Read | 51586 IOPS IOPS |
| FIO | 4k Random Write | 38424 IOPS IOPS |
| FIO | 4k Random Read | 206347 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 57.70 MB/s |
| iozone 4K random write     | 94.46 MB/s |
| iozone 1M random read      | 336.70 MB/s |
| iozone 1M random write     | 332.90 MB/s |
| iozone 1M sequential read  | 351.51 MB/s |
| iozone 1M sequential write | 348.35 MB/s |
