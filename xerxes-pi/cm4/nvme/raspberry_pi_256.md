...
| Product | [Raspberry Pi SSD Kit](https://www.raspberrypi.com/products/ssd-kit/) |
|:-|:-|
|----|-----|
| *Name* | Raspberry Pi SSD 256GB |
| *Model* | - |
| *Capacity* | 256GB |
...
This is a Samsung PM991a (M/N MZ9LQ256HBJD) with a Raspberry Pi sticker.
...
Disklabel type: dos
Disk identifier: 0x0fad56ba

Device         Boot   Start     End Sectors  Size Id Type
/dev/nvme0n1p1 *       2048 1050623 1048576  512M  c W95 FAT32 (LBA)
/dev/nvme0n1p2      1050624 7818687 6768064  3.2G 83 Linux
```
...
Full benchmark: https://pibenchmarks.com/benchmark/134331/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 204 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 356.33 MB/s |
| FIO | 4k Random Read | 74202 IOPS IOPS |
| FIO | 4k Random Write | 39158 IOPS IOPS |
| FIO | 4k Random Read | 296811 KB/s KB/s |
| FIO | 4k Random Write | 156634 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 28.77 MB/s |
| iozone 4K random write     | 89.23 MB/s |
| iozone 1M random read      | 327.67 MB/s |
| iozone 1M random write     | 318.00 MB/s |
| iozone 1M sequential read  | 336.09 MB/s |
| iozone 1M sequential write | 324.71 MB/s |
