...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: KIOXIA Corporation NVMe SSD Controller BG4 (DRAM-less) (prog-if 02 [NVM Express])
...
/dev/nvme0n1   ext4  118G  2.1M  112G   1% /mnt/sda1
```
...
Full benchmark: https://pibenchmarks.com/benchmark/134325/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 180 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 332.02 MB/s |
| FIO | 4k Random Read | 81920 IOPS IOPS |
| FIO | 4k Random Write | 36967 IOPS IOPS |
| FIO | 4k Random Read | 327680 KB/s KB/s |
| FIO | 4k Random Write | 147870 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 40.08 MB/s |
| iozone 4K random write     | 90.75 MB/s |
| iozone 1M random read      | 321.07 MB/s |
| iozone 1M random write     | 279.63 MB/s |
| iozone 1M sequential read  | 322.79 MB/s |
| iozone 1M sequential write | 286.87 MB/s |
