...
| Product | [Transcend PCIe SSD 110S & 112S](https://www.transcend-info.com/Products/No-953) |
|:-|:-|
|----|----|
| *Name* | Transcend 110S |
| *Model* | TS256GMTE110S |
...
/dev/nvme0n1   ext4  234G  2.1M  222G   1% /mnt/sda1
```
...
Full benchmark: https://pibenchmarks.com/benchmark/134312/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 204 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 321.10 MB/s |
| FIO | 4k Random Read | 72882 IOPS IOPS |
| FIO | 4k Random Write | 37372 IOPS IOPS |
| FIO | 4k Random Read | 291530 KB/s KB/s |
| FIO | 4k Random Write | 149489 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 36.03 MB/s |
| iozone 4K random write     | 94.89 MB/s |
| iozone 1M random read      | 310.19 MB/s |
| iozone 1M random write     | 304.15 MB/s |
| iozone 1M sequential read  | 321.82 MB/s |
| iozone 1M sequential write | 323.09 MB/s |
