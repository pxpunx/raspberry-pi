...
```
# lspci -vvv -s 01:00.0
01:00.0 Non-Volatile memory controller: Sandisk Corp WD Green SN350 240GB (DRAM-less) / SN560E NVMe SSD (rev 01) (prog-if 02 [NVM Express])
  Subsystem: Sandisk Corp WD Green SN350 240GB (DRAM-less) / SN560E NVMe SSD
...
Full benchmark: https://pibenchmarks.com/benchmark/134317/

| Category | Test | Result |
|:-|:-|:-|
| DD | Disk Write | 210 MB/s |
| HDParm | Disk Read | TBD |
| HDParm | Cached Disk Read | 358.19 MB/s |
| FIO | 4k Random Read | 72112 IOPS IOPS |
| FIO | 4k Random Write | 26494 IOPS IOPS |
| FIO | 4k Random Read | 288450 KB/s KB/s |
| FIO | 4k Random Write | 105976 KB/s KB/s |
...
| Benchmark                  | Result |
| -------------------------- | ------ |
| iozone 4K random read      | 38.33 MB/s |
| iozone 4K random write     | 109.47 MB/s |
| iozone 1M random read      | 345.42 MB/s |
| iozone 1M random write     | 298.75 MB/s |
| iozone 1M sequential read  | 343.59 MB/s |
| iozone 1M sequential write | 356.51 MB/s |
